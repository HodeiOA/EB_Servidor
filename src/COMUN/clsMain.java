...
public class clsMain
{
	...
	public static void main(String[] args)
	{
		...
		clsVuelo vueloIda = new clsVuelo("IB001", aeropuerto1, aeropuerto2, new Date(23, 05, 2019), 120, 120, 180.99, null);
		clsVuelo vueloVuelta = new clsVuelo("IB002", aeropuerto2, aeropuerto1, new Date(30, 05, 2019), 120, 120, 200, null);
